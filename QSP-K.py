...
class QSP-K(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QSP-K")
        ...
        # Variables
        ##################################################
        self.tabla = tabla = (0.77+0.77j,0.77+0.77j,-0.7-0.77j,0,77-0.77j)
        self.M = M = len(tabla)
        self.bps = bps = math.log(M,2)
        self.RS_5 = RS_5 = 32000
        self.RS_3 = RS_3 = 32000
        self.RS_2 = RS_2 = 32000
        self.RS_1 = RS_1 = 32000
        self.RS = RS = 32000
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_ic(tabla, 1)
    ...
    def set_RS_5(self, RS_5):
        self.RS_5 = RS_5

    def get_RS_3(self):
        return self.RS_3

    def set_RS_3(self, RS_3):
        self.RS_3 = RS_3

    def get_RS_2(self):
        return self.RS_2

    def set_RS_2(self, RS_2):
        self.RS_2 = RS_2

    def get_RS_1(self):
        return self.RS_1

    def set_RS_1(self, RS_1):
        self.RS_1 = RS_1
...
def main(top_block_cls=QSP-K, options=None):
